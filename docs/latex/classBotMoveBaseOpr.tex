...
\hypertarget{classBotMoveBaseOpr_a269ba342770db907481955adb5bd9cec}{\index{Bot\-Move\-Base\-Opr@{Bot\-Move\-Base\-Opr}!Bot\-Move\-Base\-Opr@{Bot\-Move\-Base\-Opr}}
\index{Bot\-Move\-Base\-Opr@{Bot\-Move\-Base\-Opr}!BotMoveBaseOpr@{Bot\-Move\-Base\-Opr}}
\subsubsection[{Bot\-Move\-Base\-Opr}]{\setlength{\rightskip}{0pt plus 5cm}Bot\-Move\-Base\-Opr\-::\-Bot\-Move\-Base\-Opr (
\begin{DoxyParamCaption}
\item[{const std\-::string}]{p\-Code, }
\item[{const std\-::string}]{p\-Frame\-\_\-id, }
\item[{const double}]{p\-X\-Pos, }
\item[{const double}]{p\-Y\-Pos, }
\item[{const double}]{p\-Z\-Pos, }
\item[{const double}]{p\-X\-Orient, }
\item[{const double}]{p\-Y\-Orient, }
\item[{const double}]{p\-Z\-Orient, }
\item[{const double}]{p\-W\-Orient}
\end{DoxyParamCaption}
)}}\label{classBotMoveBaseOpr_a269ba342770db907481955adb5bd9cec}


Constructor for \hyperlink{classBotMoveBaseOpr}{Bot\-Move\-Base\-Opr}; builds operation that may execute. 


\begin{DoxyParams}{Parameters}
{\em p\-Code} & std\-::string indicating operation code; must be Bot\-Move\-Base for this to execute \\
\hline
{\em p\-Scene\-Number} & integer for scene number to act on; must be within operational parameters to execute \\
\hline
{\em p\-Action} & integer for action to take; must be valid action for this to execute Constructor for \hyperlink{classBotMoveBaseOpr}{Bot\-Move\-Base\-Opr}; builds operation that may execute \\
\hline
{\em p\-Code} & std\-::string indicating operation code; must be Bot\-Move\-Base for this to execute \\
\hline
{\em p\-Frame\-\_\-id} & std\-::string for the move\-\_\-base frame\-\_\-id within which the pose is to be executed \\
\hline
{\em p\-X\-Pos} & double pose X position \\
\hline
{\em p\-Y\-Pos} & double pose Y position \\
\hline
{\em p\-Z\-Pos} & double pose Z position \\
\hline
{\em p\-X\-Orient} & double X orientation (Quaternion) \\
\hline
{\em p\-Y\-Orient} & double Y orientation (Quaternion) \\
\hline
{\em p\-Z\-Orient} & double Z orientation (Quaternion) \\
\hline
{\em p\-W\-Orient} & double W orientation (Quaternion) \\
\hline
\end{DoxyParams}
